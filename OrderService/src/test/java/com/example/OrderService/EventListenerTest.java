...
public class EventListenerTest {
    ...
    void consumePaymentResultTest() throws Exception {
        ...
        var paymentResultMessage =
                EdaMessage.PaymentResultV1.newBuilder()
                        .setOrderId(order.id)
    ...
    void consumeDeliveryStatusUpdateTest() throws Exception {
        ...
        var delivery = EdaMessage.DeliveryStatusUpdateV1.newBuilder()
                .setOrderId(order.id)
        ...
        //when
        eventListener.consumeDeliveryStatusUpdate(delivery.toByteArray());
